package com.xingyun.mvpdemo.views.widget;
...
public class FlowLikeView extends RelativeLayout implements NestedScrollingChild {
    ...
    private void initParams() {
        ...
        mLikeDrawables.add(generateDrawable(R.mipmap.heart0));
        mLikeDrawables.add(generateDrawable(R.mipmap.heart1));
        mLikeDrawables.add(generateDrawable(R.mipmap.heart2));
        mLikeDrawables.add(generateDrawable(R.mipmap.heart3));
        mLikeDrawables.add(generateDrawable(R.mipmap.heart4));
        mLikeDrawables.add(generateDrawable(R.mipmap.heart5));
        mLikeDrawables.add(generateDrawable(R.mipmap.heart6));
        mLikeDrawables.add(generateDrawable(R.mipmap.heart7));
        mLikeDrawables.add(generateDrawable(R.mipmap.heart8));
