...
public class VideoListAdapter extends BaseQuickAdapter<VideoListBean.ArticleListBean, BaseViewHolder> {
    public VideoListAdapter(@Nullable List<VideoListBean.ArticleListBean> data) {
        super(R.layout.item_video_listview, data);
    }
